...
@section('content')
    <!-- Header Banner -->
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="assets/main/img/slider/1.jpg">
        <div class="container">
            <div class="row">
    ...
    <section class="about section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col col-md-3 animate-box" data-animate-effect="fadeInUp"> <img src="assets/main/img/about/KenenisaWeb-15.jpg"
                        alt="" class="mt-90 mb-30"> </div>
                <div class="col col-md-3 animate-box" data-animate-effect="fadeInUp"> <img src="assets/main/img/about/KenenisaWeb-17.jpg"
                        alt=""> </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 owl-carousel owl-theme">
                    <div class="item">
                        <div class="img"> <img src="assets/main/img/team/4.jpg" alt=""> </div>
                        <div class="info">
                    ...
                    <div class="item">
                        <div class="img">
                            <img src="assets/main/img/team/1.jpg" alt="">
                        </div>
                        <div class="info">
                            <h6>Micheal White</h6>
                    ...
                    <div class="item">
                        <div class="img"> <img src="assets/main/img/team/2.jpg" alt=""> </div>
                        <div class="info">
                            <h6>Olivia Martin</h6>
                    ...
                    <div class="item">
                        <div class="img"> <img src="assets/main/img/team/5.jpg" alt=""> </div>
                        <div class="info">
                            <h6>Mariana Dana</h6>
                            <p>F&B Manager</p>
                            <div class="social valign">
                    ...
                    <div class="item">
                        <div class="img"> <img src="assets/main/img/team/3.jpg" alt=""> </div>
                        <div class="info">
                            <h6>Enrico Brown</h6>
                            <p>Head Chef</p>
                            <div class="social valign">
                    ...
                    <div class="item">
                        <div class="img"> <img src="assets/main/img/team/6.jpg" alt=""> </div>
                        <div class="info">
                            <h6>Victoria Dan</h6>
                        ...
                        <div class="testimonials-box">
                            ...
                            <div class="owl-carousel owl-theme">
                                <div class="item">
                                    ...
                                    <div class="info">
                                        <div class="author-img"> <img src="assets/main/img/team/4.jpg" alt=""> </div>
                                        <div class="cont">
                                            <span>
                                                <i class="star-rating"></i>
                                                <i class="star-rating"></i>
                                ...
                                <div class="item"> <span class="quote"><img src="assets/main/img/quot.png" alt=""></span>
                                    <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the lemon
                                        sanleo nectan feugiat erat hendrerit necuis ve ante otel inilla duiman at finibus
                                        viverra neca the sene on satien the miss drana inc fermen norttito sit space, mus
                                        nellentesque habitan.</p>
                                    <div class="info">
                                        <div class="author-img"> <img src="assets/main/img/team/1.jpg" alt=""> </div>
                                        <div class="cont">
                                            <span>
                                                <i class="star-rating"></i>
                                                <i class="star-rating"></i>
                                ...
                                <div class="item">
                                    ...
                                    <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the lemon
                                        ...
                                        nellentesque habitan.</p>
                                    <div class="info">
                                        <div class="author-img"> <img src="assets/main/img/team/5.jpg" alt=""> </div>
                                        <div class="cont">
                                            <span>
                                                <i class="star-rating"></i>
                                                <i class="star-rating"></i>
